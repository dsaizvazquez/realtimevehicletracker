...
int main(int argc, char * argv[])
{
    ...
    std::string nnetFile ="models/yolov5.onnx";
    std::string inputFile ="models/coco.names";
    std::string outputFile ="Output.jpg";

    int c;
    while ((c = getopt (argc, argv, "hc:n:i:o:")) != -1){
        ...
        case 'h':
            printf( "[-h] [-c -n -i -o] -- program to obtain predictions from image\n where:\n  -h  show this help text\n  -c  coco.names\n  -n  neural net weights\n  -i  input image\n  -o  output image\n");
            exit(0);
            break;
